 ...
 *
 */
$route['*']['/'] = array('MainController', 'index');//主页
$route['*']['/error'] = array('ErrorController', 'index');//错误页
$route['*']['/index'] = array('MainController','index');//主页
$route['*']['/admin'] = array('MainController','admin');//后台管理主页
$route['*']['/add'] = array('MainController','add');//添加新闻
$route['*']['/addpost'] = array('MainController','add_post');//提交添加新闻
$route['*']['/news/:id'] = array('MainController','news_id');//新闻内容详细页
$route['*']['/admin/edit/:id'] = array('MainController','edit');//更新新闻
$route['*']['/admin/update/:id'] = array('MainController','update_post');//提交新闻更新
$route['*']['/admin/delete/:id'] = array('MainController','delete_post');//提交删除新闻
